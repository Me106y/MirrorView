...
export function Shell({ onOpenSettings }: { onOpenSettings: () => void }) {
  ...
  return (
    <div className={`app-shell${location.pathname.startsWith("/resume-craft") ? " app-shell-resume-craft" : ""}${location.pathname.startsWith("/cover-letter") ? " app-shell-cover-letter" : ""}`}>
